...
namespace VTMES3_RE {
    ...
    public partial class CodeDataSet : global::System.Data.DataSet {
        ...
        public partial class CodeUserDataTable : global::System.Data.TypedTableBase<CodeUserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CodeUserRow AddCodeUserRow(string CorpId, string EmployeeName, string Password, string AuthorGroup, byte[] Photo, string TeamName) {
        ...
        public partial class CodeUserRow : global::System.Data.DataRow {
            ...
            public string TeamName {
                get {
                    try {
                        return ((string)(this[this.tableCodeUser.TeamNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("\'CodeUser\' 테이블의 \'TeamName\' 열의 값이 DBNull입니다.", e);
                    }
                }
                set {
                    this[this.tableCodeUser.TeamNameColumn] = value;
                }
            }
            ...
            public bool IsTeamNameNull() {
                return this.IsNull(this.tableCodeUser.TeamNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetTeamNameNull() {
                this[this.tableCodeUser.TeamNameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace VTMES3_RE.CodeDataSetTableAdapters {
    ...
    public partial class CodeUserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [CodeUser] WHERE (([CorpId] = @Original_CorpId) AND ([EmployeeName] = @Original_EmployeeName) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_AuthorGroup = 1 AND [AuthorGroup] IS NULL) OR ([AuthorGroup] = @Original_AuthorGroup)) AND ((@IsNull_TeamName = 1 AND [TeamName] IS NULL) OR ([TeamName] = @Original_TeamName)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [CodeUser] ([CorpId], [EmployeeName], [Password], [AuthorGroup], [Photo], [TeamName]) VALUES (@CorpId, @EmployeeName, @Password, @AuthorGroup, @Photo, @TeamName);
SELECT CorpId, EmployeeName, Password, AuthorGroup, Photo, TeamName FROM CodeUser WHERE (CorpId = @CorpId) AND (EmployeeName = @EmployeeName)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [CodeUser] SET [CorpId] = @CorpId, [EmployeeName] = @EmployeeName, [Password] = @Password, [AuthorGroup] = @AuthorGroup, [Photo] = @Photo, [TeamName] = @TeamName WHERE (([CorpId] = @Original_CorpId) AND ([EmployeeName] = @Original_EmployeeName) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_AuthorGroup = 1 AND [AuthorGroup] IS NULL) OR ([AuthorGroup] = @Original_AuthorGroup)) AND ((@IsNull_TeamName = 1 AND [TeamName] IS NULL) OR ([TeamName] = @Original_TeamName)));
SELECT CorpId, EmployeeName, Password, AuthorGroup, Photo, TeamName FROM CodeUser WHERE (CorpId = @CorpId) AND (EmployeeName = @EmployeeName)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CorpId, EmployeeName, Password, AuthorGroup, Photo, TeamName FROM CodeUser" +
                " WHERE (CorpId = @pCorpId)";
            ...
            this._commandCollection[1].CommandText = "\r\n\t\t\t\t\t\tSELECT cu.*, \'\' Password2, emp.FullName\r\n\t\t\t\t\t\tFROM dbo.CodeUser cu\r\n\t\t\t\t" +
                "\t\tInner Join RYCAMDB.CAMDBsh.Employee emp on cu.EmployeeName = emp.EmployeeName\r" +
        ...
        public virtual int Delete(string Original_CorpId, string Original_EmployeeName, string Original_Password, string Original_AuthorGroup, string Original_TeamName) {
            ...
            if ((Original_TeamName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((string)(Original_TeamName));
            }
        ...
        public virtual int Insert(string CorpId, string EmployeeName, string Password, string AuthorGroup, byte[] Photo, string TeamName) {
            if ((CorpId == null)) {
            ...
            if ((TeamName == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(TeamName));
            }
        ...
        public virtual int Update(string CorpId, string EmployeeName, string Password, string AuthorGroup, byte[] Photo, string TeamName, string Original_CorpId, string Original_EmployeeName, string Original_Password, string Original_AuthorGroup, string Original_TeamName) {
            if ((CorpId == null)) {
                throw new global::System.ArgumentNullException("CorpId");
            }
            else {
            ...
            if ((TeamName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(TeamName));
            }
            if ((Original_CorpId == null)) {
                throw new global::System.ArgumentNullException("Original_CorpId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_CorpId));
            }
            if ((Original_EmployeeName == null)) {
                throw new global::System.ArgumentNullException("Original_EmployeeName");
            }
            ...
            if ((Original_AuthorGroup == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_AuthorGroup));
            }
            if ((Original_TeamName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_TeamName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string AuthorGroup, byte[] Photo, string TeamName, string Original_CorpId, string Original_EmployeeName, string Original_Password, string Original_AuthorGroup, string Original_TeamName) {
            return this.Update(Original_CorpId, Original_EmployeeName, Password, AuthorGroup, Photo, TeamName, Original_CorpId, Original_EmployeeName, Original_Password, Original_AuthorGroup, Original_TeamName);
        }
    }
